...
export function renderAdminSidebar() {
    ...
    <ul class="sidebar-nav">
        <li><a href="/pages/admin/index.html" class="${path.endsWith('index.html') ? 'active' : ''}"><i class="fa-solid fa-tachometer-alt"></i>Dashboard</a></li>
        <li><a href="/pages/admin/users.html" class="${path.endsWith('users.html') ? 'active' : ''}"><i class="fa-solid fa-users"></i>Quản lí người dùng</a></li>
