...
export function renderAdminSidebar() {
    ...
    <ul class="sidebar-nav">
        <li><a href="/pages/admin/dashboard.html" class="${path.endsWith('dashboard.html') ? 'active' : ''}"><i class="fa-solid fa-chart-line"></i>Dashboard</a></li>
        ...
        <li><a href="/pages/admin/inventory1.html" class="${path.endsWith('inventory1.html') ? 'active' : ''}"><i class="fa-solid fa-plus-circle"></i> Tạo phụ tùng mới</a></li>
        <li><a href="/pages/admin/request.html" class="${path.endsWith('request.html') ? 'active' : ''}"><i class="fa-solid fa-cogs"></i>Phiếu đề xuất</a></li>
        <li><a href="#" id=""><i class="fa-solid fa-shield-halved"></i>Chính sách BH</a></li>
