...
public class PartInventoryMapper {
     ...
     */
    public static PartInventory toPartInventory(PartInventoryRequest request) {
    ...
    public static PartInventoryResponse toPartInventoryResponse(PartInventory inventory) {
        return PartInventoryResponse.builder()
                .inventoryId(inventory.getInventoryId())
                .partId(inventory.getPart().getPartId())
                .partName(inventory.getPart().getName())
                .partType(inventory.getPart().getPartType())
                .serialNumber(inventory.getPart().getSerialNumber())
                .price(inventory.getPart().getPrice())
